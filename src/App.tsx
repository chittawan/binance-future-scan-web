      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-1">
            <Link
              to="/config"
              className="px-4 py-2 rounded-md font-medium text-sm text-binance-text-secondary hover:text-binance-yellow hover:bg-binance-yellow/10 transition-all duration-200 flex items-center gap-2"
            >
